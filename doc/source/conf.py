# -*- coding: utf-8 -*-
#
# dasDuckDB documentation build configuration file.
#
...
project = u'dasDuckDB documentation'
...
# Intermediate files used by duckdb2rst — not standalone documentation pages.
...
htmlhelp_basename = 'dasduckdb_doc'
